...
bool Clown::defeated()
{
	...
	std::cout << name << " has laughed himself to exhaustion!\n";
...
int Clown::attack()
{
	...
	else
	{
		...
		std::cout <<"That joke was a flop. You suppress a yawn.\n\n";
...
int Clown::checkWeapon(Item * weapon)
{
