...
bool Ghost::defeated()
{
	...
	std::cout << name << " was scared to death (again)!\n";
...
int Ghost::attack()
{
	...
	else
	{
		...
		std::cout << "You're not scared at all and try to suppress "
			<< "a yawn!\n\n";
...
int Ghost::checkWeapon(Item * weapon)
{
